...
import { POPDI6Survey } from "./POPDI6Survey"

describe("POPDI6Survey", () => {
    let survey: POPDI6Survey
    const surveyName = "POPDI-6"
    const surveySubtitle = "Pelvic Organ prolapse Distress Inventory"
    const scaleName = "POPDI6"
    const scaleLength = 6
    const maxTotalScore = 24
    const optionScale = [0, 1, 2, 3, 4]

    beforeEach(() => {
        survey = new POPDI6Survey()
    })
    ...
    describe("scaling", () => {
        ...
        it("should have scale question count of 6", () => {
